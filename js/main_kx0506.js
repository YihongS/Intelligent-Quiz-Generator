...
$(document).ready(function(){
	...
	function changeQuestion(){
		...
		correctOptions = qd[countQ]["Correct_answer_choice"];
		console.log("IN CHANGE QUEStiON function",correctOptions)
...
// right now, way1: change the check correct function
	// way2: change the changeOption function


	// Check if the chosen options are correct
	function checkCorrect(){
		console.log("entered function checkCorrect")
	...
	$('.btn_submit').click(function (){
		checkCorrect();
		console.log("question correct【countQ】: " + questionCorrect[countQ]+" countQ: "+countQ);
		continueScene(this);
	...
	$('.btn_next_question').click(function (){
		...
		//console.log("check question correct", questionCorrect)
		//@@kx
...
// need to see how to change options after used several
